...
ADMINS = [("""ABBA Marketing Agency""", "abba-marketing-agency@yec.itlink.uz")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Yec API",
    "DESCRIPTION": "Documentation of API endpoints of Yec",
    "VERSION": "1.0.0",
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "YEC Gilam Admin",
    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "YEC Gilam",
    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "YEC Gilam",
    ...
    "welcome_sign": "Добро пожаловать в админ-панель YEC Gilam",
    # Copyright on the footer
    "copyright": "YEC Gilam",
    # The model admin to search from the search bar, search bar omitted if excluded
    "search_model": ["catalog.Carpet", "catalog.Collection", "catalog.News"],
    ...
    "icons": {
        ...
        "catalog.TypeCarpetCollection": "fas fa-tags",
        "catalog.Collection": "fas fa-layer-group",
        "catalog.Carpet": "fas fa-couch",
        "catalog.Style": "fas fa-palette",
        "catalog.Room": "fas fa-home",
        "catalog.Color": "fas fa-fill-drip",
        "catalog.News": "fas fa-newspaper",
        "catalog.Gallery": "fas fa-images",
    },
...
# Instaloader settings (для open source решения)

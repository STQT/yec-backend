...
**Если получили ошибку "Checkpoint required":**

Это означает, что Instagram требует проверку безопасности. Решение:

1. **Откройте ссылку проверки** из сообщения об ошибке в браузере (желательно на том же IP-адресе сервера)
2. **Пройдите проверку безопасности** в браузере (подтвердите, что это вы)
3. **Подождите 10-15 минут** после прохождения проверки
4. **Попробуйте создать сессию снова**

**Альтернативные способы:**

- Используйте другой аккаунт Instagram (менее защищенный)
- Войдите в Instagram через браузер на том же IP-адресе перед созданием сессии
- Используйте Instagram App на мобильном устройстве для подтверждения активности
